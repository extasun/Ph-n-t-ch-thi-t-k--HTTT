					...
					<div>
						<c:choose>
							<c:when test="${status_add_account==1}">
								<div class="alert alert-success" role="alert">Thêm tài
									khoản thành công</div>
							${status_add_account=null}
						</c:when>

							<c:when test="${status_add_account==0}">
								<div class="alert alert-warning" role="alert">Thêm tài
									khoản thất bại</div>
							${status_add_account=null}
						</c:when>
							<c:otherwise>
						...
						<div class="panel panel-info " style="margin-bottom: 15px">
							<div class="panel-body">
								...
								<a class="btn btn-success"
									href="${pageContext.servletContext.contextPath}/admin/newaccount.htm">Thêm
									tài khoản</a>
							</div>
						</div>
					</div>
